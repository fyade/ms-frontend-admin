...
<template>
  ...
  >
    ...
    <template v-if="activeTabName===final.one">
      ...
      >
        ...
        <!--  <el-input-number v-model="state.dialogForm.orderNum" controls-position="right"/>-->
        <!--</el-form-item>-->
        <!--<el-form-item :label="deptDict.ifDefault" prop='ifDefault'>-->
  ...
  <div class="zs-table-data">
    ...
    >
      ...
      <!--上面id列的宽度改一下-->
      <!--在此下方添加表格列-->
      <el-table-column prop="label" :label="deptDict.label" width="120"/>
      ...
      <!--在此上方添加表格列-->
      <!--<el-table-column prop="createRole" :label="deptDict.createRole" width="120"/>-->
      <!--<el-table-column prop="updateRole" :label="deptDict.updateRole" width="120"/>-->
