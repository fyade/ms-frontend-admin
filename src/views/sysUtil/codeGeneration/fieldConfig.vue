...
const props = defineProps({
  table: {
    type: Object as () => chooseTableTableIntre,
    required: true
  }
})

const dataTableRef = ref<null | any>(null)
onMounted(() => {
  if (dataTableRef.value && dataTableRef.value?.toggleAllSelection) {
